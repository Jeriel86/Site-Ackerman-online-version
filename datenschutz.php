<?php
    ...
    <div class="container">
        ...
        <h4><strong class="fw-bold">Allgemeine Hinweise</strong></h4>
        <p>Die folgenden Hinweise geben einen kurzen und einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie unsere Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.
        </p>
        <p>
        <h4 class="fw-bold">Datenerfassung auf dieser Website</h4>
        Verantwortlicher für die Datenerfassung:<br>
        Sascha Ackermann <br>
        Weinstraße Süd 20 <br>
        67098 Bad Dürkheim <br>

        </p>
        <p>
        Ihre Daten werden zum einen dadurch erhoben, dass Sie uns diese mitteilen. Hierbei kann es sich z. B. um Daten handeln, die Sie in ein Kontaktformular eingeben. Ein Teil der Daten werden erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden. Die personenbezogenen Daten werden erhoben, um eine Beratungsgrundlage zu sichern.<br></p>
        <p>
            ...
            dieser
            Daten erfolgt automatisch, sobald Sie unsere Website betreten.</br></p>
        <p>
        ...
        <p>
            ...
            möglich.<br></p>
        <p>
        <h4 class="fw-bold">Widerruf und Ihre Rechte</h4>
        Sie haben jederzeit das Recht, unentgeltlich Auskunft über Herkunft, Empfänger und Zweck Ihrer gespeicherten
        personenbezogenen Daten zu erhalten. Sie können darüber hinaus jederzeit ohne Angabe von Gründen von Ihrem
        Widerspruchsrecht Gebrauch machen, ohne dass dies Einfluss auf die bestehenden und/oder künftigen
        Vertragsverhältnisse hat sowie die erteilte/-n Einwilligung/-en mit Wirkung für die Zukunft abändern oder
        gänzlich widerrufen. Für den Widerruf der Einwilligung/-en schicken Sie eine E-Mail an info@ackermann.vkb.de
        oder unter dem Impressum angebende Adresse. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung
        bleibt vom Widerruf unberührt.<br></p>
        <p>
            Des Weiteren steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu.<br>
        </p>
        <p>Landesbeauftragte für den Datenschutz und die Informationsfreiheit Rheinland-Pfalz</p>
        <p>Besucheradresse: Hintere Bleiche 34, 55116 Mainz</p>
        <p>Postanschrift: Postfach 3040, 55116 Mainz</p>
        <p>Telefon: +49 (0) 6131 8920-0</p>
        <p>Fax: +49 (0) 6131 8920-299</p>
        ...
        <p>
            ...
            Einschränkung der Verarbeitung“.<br></p>
        <p>
        <h4 class="fw-bold">Hinweis zur verantwortlichen Stelle</h4>
        Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:<br></p>
        Generalagentur Sascha Ackermann<br>
        Weinstraße Süd 20<br>
        67098 Bad Dürkheim<br>
        Telefon: 06322 790 6 790<br>
        E-Mail: info@ackermann.vkb.de<br>
        Verantwortliche Stelle ist die natürliche oder juristische Person, die allein oder gemeinsam mit anderen über
        die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten (z. B. Namen, E-Mail-Adressen o. Ä.)
        entscheidet.
        </p>
        <p>
        <h3 class="fw-bold">Datenschutzbeauftragter: </h3>
        Sascha Ackermann <br>
        Weinstraße Süd 20 <br>
        67098 Bad Dürkheim <br>
        Telefon: 06322 790 6 790 <br>
        ...
        <h4 class="fw-bold">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung
            (Art. 21 DSGVO)</h4>
        Wenn die Datenverarbeitung auf Grundlage von Art. 6 Abs. 1 Lit. E oder F erfolgt, haben Sie jederzeit das Recht,
        aus Gründen, die sich aus Ihrer besonderen Situation ergeben, gegen die Verarbeitung Ihrer personenbezogener
        ...
        <p>
        <h4 class="fw-bold">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h4>
        ...
        gerichtlicher Rechtsbehelfe. <br></p>
        <p>
        <h4 class="fw-bold">Recht auf Datenübertragbarkeit</h4>
        ...
        dies nur, soweit es technisch machbar ist. <br>
        </p>
        <p>
        <h4 class="fw-bold">SSL- bzw. TLS-Verschlüsselung</h4>
        ...
        <p>
        <h4 class="fw-bold">Auskunft, Löschung und Berichtigung</h4>
        ...
        <p>
        <h4 class="fw-bold">Recht auf Einschränkung der Verarbeitung</h4>
        ...
        <p>
        <h4 class="fw-bold">Widerspruch gegen Werbe-E-Mails</h4>
        Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten zur Übersendung von nicht ausdrücklich angeforderter Werbung und Informationsmaterialien wird hiermit widersprochen. Die Betreiber der Seiten behalten sich ausdrücklich rechtliche Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwa durch Spam-E-Mails, vor.<br>
        </p>
        <p>
        <h4 class="fw-bold">Kontaktformular</h4>
        Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter, es sei denn, dass es zur Bearbeitung und Bearbeitung Ihrer Kontaktanfrage erforderlich ist oder Sie haben uns Ihre entsprechende Einwilligung erteilt.<br>
        ...
        <p>
        <h4 class="fw-bold">Anfrage per E-Mail, Telefon oder Telefax</h4>
        ...
        <p>
        <h4 class="fw-bold">Externes Hosting</h4>
        ...
        <p>
        <h4 class="fw-bold">Abschluss eines Vertrages über Auftragsverarbeitung</h4>
        Um die datenschutzkonforme Verarbeitung zu gewährleisten, haben wir einen Vertrag über Auftragsverarbeitung mit unserem Hoster geschlossen.
        </p>
        <p>
        <h4 class="fw-bold">Newsletterdaten </h4>
