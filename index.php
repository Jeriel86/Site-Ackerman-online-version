    ...
    <div id="carouselExampleCaptions" class="carousel slide " data-bs-ride="carousel">
      ...
      <div class="carousel-inner slider justify-content-center">
        ...
        <div class="carousel-item active">
          ...
          <div class="carousel-item-description carou">
            <ul class="txt my-3" style="overflow:scroll;height:200px;">
              <h4 class="mt-1">Willkommen bei der Generalagentur Sascha Ackermann</h4>
        ...
        <div class="carousel-item">
          ...
          <div class="overlay"></div>
          <div class="carousel-item-description">
            <ul class="txt"style="overflow:scroll;height:200px;">
    ...
    <section style="background-color:rgb(166,166,166);">
        ...
        <div class="container">
            <div class="ligne px-5 px-sm-1">
                ...
                <div class="colone">
                    <div  class="col-md-4 mb-2 align-self-center text-center">
                    <a role="button" type="button" class="button-beruf-1 text-dark text-center text-decoration-none"
                       href="Krankenversicherung.php"><br>Beamte
            ...
            <?php for($i=0; $i < count($testimonials); $i++ ){ ?>
                <div class="mySlides">
                    ...
                    <?php for($j=0; $j<3; $j++){ 
                        ...
                        <div class="col-md-4 mb-2 order-md-6 align-self-start text-center">
                            <button type="button" class="bt text-light bt1 p-2" style="overflow:auto;">
                                „ <?php echo $testimonials[$i][$j]["content"]  ?> “
                            </button>
